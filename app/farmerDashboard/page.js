...
{/* 
      ...
      >
        <motion.button
          ...
          onClick={() => alert("🤖 FarmBot chat feature will open here")}
        >
      ...
      >
        ...
        >
          <h2 className="text-2xl font-semibold text-green-700 mb-2">New Orders</h2>
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl shadow-md p-8 border-t-4 border-green-600 hover:shadow-lg transition"
        >
          <h2 className="text-2xl font-semibold text-green-700 mb-2">Sold Orders</h2>
          <p className="text-gray-600 mb-4">
