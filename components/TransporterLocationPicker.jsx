...
export default function TransporterLocationPicker() {
  ...
  const saveLocation = async () => {
    if (!selected) return toast.error("Select a location first!");
    try {
      const res = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/transporter/save-location`, {
  ...
  return (
    <div>
      <h2>Pick Your Transport Location</h2>
